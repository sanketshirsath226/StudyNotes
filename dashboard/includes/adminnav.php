 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../notes/notes.php">COLLEGE-NOTES-GALLERY</a>
            </div>
            
            <ul class="nav navbar-right top-nav">
                <?php if($_SESSION['role'] !== 'admin') { ?> <li><a href="../notes/notes.php">UPLOAD</a></li> <?php } ?>
                <li class="dropdown">
                ...
                <?php if($_SESSION['role'] == 'admin') {
                   ...
                   <li>
                    ...
                    <li>
                        ...
                        <ul id="user" class="collapse">
                            <li>
                                <a href="../notes/notes.php">View All Notes</a>
                            </li>
                            <li>
                                <a href="../notes/notes.php">Upload Note</a>
                            </li>
